...
Comprehensive checklist to address all known issues, TODOs, and code analysis findings. Complete these items before tagging v1.0.0.
...
The upstream SpaceMolt MCP server handshake is broken. Game tools are unavailable.

- [ ] **Implement offline/stub mode for development**
...
- [ ] **Report issue to SpaceMolt maintainers**
  - Reference: `documentation/KNOWN_SERVER_ISSUES.md`
  - Include reproduction steps and curl commands from documentation
  - Track response and update KNOWN_SERVER_ISSUES.md with ticket link

- [ ] **Add retry logic with exponential backoff**
  - Modify `internal/mcp/client.go` Initialize to retry 3x
...
- [ ] **Suppress nudge during known wait states**
...
- [ ] **Parse arrival_tick from tool results**
...
- [ ] **Create internal/constants package or file**
...
- [ ] **MysisInfo.CreatedAt not displayed**
...
- [ ] **LogEntry.SenderID display incomplete**
...
- [ ] **SwarmMessageInfo sender not displayed**
...
- [ ] **Golden tests use hardcoded dates**
...
- [ ] **MockProvider returns instant responses**
...
- [ ] **Test terminal size is fixed at 120x40**
...
- [ ] **17 tests fail due to FinalModel timeout**
...
- [ ] **Document integration test pattern in TUI_TESTING.md**
...
- [ ] **Add mysis count to focus view header**
...
- [ ] **Show broadcast sender in dashboard**
...
|-------|-------|-----------|---------|
| 1. Critical Blockers | 5 | 0 | 1 (MCP server) |
| 2. Prompt & Behavior | 7 | 0 | 0 |
| 3. Concurrency | 5 | 0 | 0 |
| 4. Error Handling | 4 | 0 | 0 |
| 5. Testing | 5 | 0 | 0 |
| 6. Database | 3 | 0 | 0 |
| 7. Configuration | 3 | 0 | 0 |
| 8. Code Quality | 3 | 0 | 0 |
| 9. Documentation | 4 | 0 | 0 |
| 10. TODO.md | 4 | 0 | 0 |
| 11. TUI Data Visibility | 18 | 0 | 0 |
